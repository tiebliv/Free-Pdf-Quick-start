    ...
    <div className="bg-stone-50 font-sans text-stone-900 selection:bg-stone-900 selection:text-white">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center p-8 text-center relative overflow-hidden text-white">
        ...
        <motion.div
          ...
          className="max-w-3xl relative z-10 px-8 py-16"
        >
          <div className="mb-12">
            <span className="inline-block px-4 py-1 rounded-full border border-white/20 text-[10px] uppercase tracking-[0.5em] text-white/80 backdrop-blur-md mb-6">
              Official Guide
            </span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-serif italic mb-8 leading-[0.9] tracking-tight text-white drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
            Meerakapp™ <br /> 
            <span className="text-4xl md:text-6xl block mt-4 font-sans not-italic font-light tracking-[0.2em] uppercase opacity-90">
              Quick Start Guide
            </span>
          </h1>

          <div className="h-px w-32 bg-gradient-to-r from-transparent via-white/40 to-transparent mx-auto mb-10" />

          <p className="text-xl md:text-2xl font-light text-stone-100 mb-12 max-w-xl mx-auto leading-relaxed drop-shadow-md">
            Mastering the 30-Second Responder System to Capture Missed Leads and Elevate Your Professionalism
          </p>
          
          <div className="flex flex-col items-center gap-4">
            <p className="text-[10px] uppercase tracking-[0.3em] text-stone-300 font-semibold">
              Meerakapp™ Solutions
            </p>
          </div>
        </motion.div>
